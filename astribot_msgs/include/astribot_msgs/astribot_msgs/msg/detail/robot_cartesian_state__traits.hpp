...
#ifndef ASTRIBOT_MSGS__MSG__DETAIL__ROBOT_CARTESIAN_STATE__TRAITS_HPP_
#define ASTRIBOT_MSGS__MSG__DETAIL__ROBOT_CARTESIAN_STATE__TRAITS_HPP_
...
inline std::string to_yaml(const RobotCartesianState & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const astribot_msgs::msg::RobotCartesianState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const astribot_msgs::msg::RobotCartesianState & msg)
{
  return astribot_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<astribot_msgs::msg::RobotCartesianState>()
{
  return "astribot_msgs::msg::RobotCartesianState";
}

template<>
inline const char * name<astribot_msgs::msg::RobotCartesianState>()
{
  return "astribot_msgs/msg/RobotCartesianState";
}

template<>
struct has_fixed_size<astribot_msgs::msg::RobotCartesianState>
...
template<>
struct has_bounded_size<astribot_msgs::msg::RobotCartesianState>
...
template<>
struct is_message<astribot_msgs::msg::RobotCartesianState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ASTRIBOT_MSGS__MSG__DETAIL__ROBOT_CARTESIAN_STATE__TRAITS_HPP_
