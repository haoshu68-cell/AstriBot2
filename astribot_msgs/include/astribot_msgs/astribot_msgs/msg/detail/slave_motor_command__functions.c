...
astribot_msgs__msg__SlaveMotorCommand__init(astribot_msgs__msg__SlaveMotorCommand * msg)
{
  ...
  if (!astribot_msgs__msg__AstribotHeader__init(&msg->header)) {
    astribot_msgs__msg__SlaveMotorCommand__fini(msg);
    return false;
  }
  // slave_motor_command
  for (size_t i = 0; i < 3; ++i) {
    if (!astribot_msgs__msg__MotorCommand__init(&msg->slave_motor_command[i])) {
      astribot_msgs__msg__SlaveMotorCommand__fini(msg);
      return false;
    }
  }
...
astribot_msgs__msg__SlaveMotorCommand__fini(astribot_msgs__msg__SlaveMotorCommand * msg)
{
  ...
  // slave_motor_command
  for (size_t i = 0; i < 3; ++i) {
    astribot_msgs__msg__MotorCommand__fini(&msg->slave_motor_command[i]);
  }
}
...
astribot_msgs__msg__SlaveMotorCommand__are_equal(const astribot_msgs__msg__SlaveMotorCommand * lhs, const astribot_msgs__msg__SlaveMotorCommand * rhs)
{
  ...
  // slave_motor_command
  for (size_t i = 0; i < 3; ++i) {
    if (!astribot_msgs__msg__MotorCommand__are_equal(
        &(lhs->slave_motor_command[i]), &(rhs->slave_motor_command[i])))
    {
      return false;
    }
  }
  ...
  astribot_msgs__msg__SlaveMotorCommand * output)
{
  ...
  for (size_t i = 0; i < 3; ++i) {
    if (!astribot_msgs__msg__MotorCommand__copy(
        &(input->slave_motor_command[i]), &(output->slave_motor_command[i])))
    {
      return false;
    }
  }
...
astribot_msgs__msg__SlaveMotorCommand__create()
{
  ...
  astribot_msgs__msg__SlaveMotorCommand * msg = (astribot_msgs__msg__SlaveMotorCommand *)allocator.allocate(sizeof(astribot_msgs__msg__SlaveMotorCommand), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(astribot_msgs__msg__SlaveMotorCommand));
  bool success = astribot_msgs__msg__SlaveMotorCommand__init(msg);
  if (!success) {
...
astribot_msgs__msg__SlaveMotorCommand__Sequence__init(astribot_msgs__msg__SlaveMotorCommand__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  astribot_msgs__msg__SlaveMotorCommand * data = NULL;

  if (size) {
    data = (astribot_msgs__msg__SlaveMotorCommand *)allocator.zero_allocate(size, sizeof(astribot_msgs__msg__SlaveMotorCommand), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = astribot_msgs__msg__SlaveMotorCommand__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        astribot_msgs__msg__SlaveMotorCommand__fini(&data[i - 1]);
      }
...
astribot_msgs__msg__SlaveMotorCommand__Sequence__fini(astribot_msgs__msg__SlaveMotorCommand__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      astribot_msgs__msg__SlaveMotorCommand__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  astribot_msgs__msg__SlaveMotorCommand__Sequence * array = (astribot_msgs__msg__SlaveMotorCommand__Sequence *)allocator.allocate(sizeof(astribot_msgs__msg__SlaveMotorCommand__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = astribot_msgs__msg__SlaveMotorCommand__Sequence__init(array, size);
  if (!success) {
...
astribot_msgs__msg__SlaveMotorCommand__Sequence__destroy(astribot_msgs__msg__SlaveMotorCommand__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    astribot_msgs__msg__SlaveMotorCommand__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
astribot_msgs__msg__SlaveMotorCommand__Sequence__are_equal(const astribot_msgs__msg__SlaveMotorCommand__Sequence * lhs, const astribot_msgs__msg__SlaveMotorCommand__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!astribot_msgs__msg__SlaveMotorCommand__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  astribot_msgs__msg__SlaveMotorCommand__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(astribot_msgs__msg__SlaveMotorCommand);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    astribot_msgs__msg__SlaveMotorCommand * data =
      (astribot_msgs__msg__SlaveMotorCommand *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!astribot_msgs__msg__SlaveMotorCommand__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          astribot_msgs__msg__SlaveMotorCommand__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!astribot_msgs__msg__SlaveMotorCommand__copy(
