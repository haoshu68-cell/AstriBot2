...
bool astribot_msgs__msg__custom_point__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * astribot_msgs__msg__custom_point__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool astribot_msgs__msg__livox_custom_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("astribot_msgs.msg._livox_custom_msg.LivoxCustomMsg", full_classname_dest, 50) == 0);
  }
  astribot_msgs__msg__LivoxCustomMsg * ros_message = _ros_message;
  {  // header
  ...
  {  // points
    ...
    if (!astribot_msgs__msg__CustomPoint__Sequence__init(&(ros_message->points), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create astribot_msgs__msg__CustomPoint__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    astribot_msgs__msg__CustomPoint * dest = ros_message->points.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!astribot_msgs__msg__custom_point__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of LivoxCustomMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("astribot_msgs.msg._livox_custom_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LivoxCustomMsg");
  ...
  {  // points
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = astribot_msgs__msg__custom_point__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
