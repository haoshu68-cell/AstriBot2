...
bool astribot_msgs__msg__robot_cartesian_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("astribot_msgs.msg._robot_cartesian_state.RobotCartesianState", full_classname_dest, 60) == 0);
  }
  astribot_msgs__msg__RobotCartesianState * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of RobotCartesianState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("astribot_msgs.msg._robot_cartesian_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RobotCartesianState");
