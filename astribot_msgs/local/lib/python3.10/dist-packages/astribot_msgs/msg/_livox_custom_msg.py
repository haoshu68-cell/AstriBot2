...
class Metaclass_LivoxCustomMsg(type):
    """Metaclass of message 'LivoxCustomMsg'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'astribot_msgs.msg.LivoxCustomMsg')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__livox_custom_msg
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__livox_custom_msg
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__livox_custom_msg
            cls._TYPE_SUPPORT = module.type_support_msg__msg__livox_custom_msg
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__livox_custom_msg

            from astribot_msgs.msg import CustomPoint
...
class LivoxCustomMsg(metaclass=Metaclass_LivoxCustomMsg):
    """Message class 'LivoxCustomMsg'."""
    ...
    _fields_and_field_types = {
        ...
        'lidar_id': 'uint8',
        'rsvd': 'uint8[3]',
        'points': 'sequence<astribot_msgs/CustomPoint>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['astribot_msgs', 'msg'], 'CustomPoint')),  # noqa: E501
    )
